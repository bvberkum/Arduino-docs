...
uint8_t trans_addr[5] = { 0x98, 0x76, 0x54, 0x32, 0x11 };	// Transmitter address
...
void setup()
{
	...
	uint8_t value;
	get_register(SETUP_AW, &value, 1);
	Serial.print("SETUP_AW: ");
	Serial.println(value);
	get_register(SETUP_RETR, &value, 1);
	Serial.print("SETUP_RETR: ");
	Serial.println(value);
	get_register(RF_CH, &value, 1);
