...
class NeoPatterns : public Adafruit_NeoPixel
{
    ...
    void RainbowCycleUpdate()
    {
        ...
        {
            //setPixelColor(i, DimColor(DimColor(DimColor(DimColor(DimColor(DimColor(Wheel(((i * 256 / numPixels()) + Index) & 255))))))));
...
NeoPatterns Ring2(7, 6, NEO_GRB + NEO_KHZ800, &Ring2Complete);
