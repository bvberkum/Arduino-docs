...
#endif //_DS
#if _HMC5883L
	payload.magnx = smoothedAverage(payload.magnx, HMC5803L_Read(X));
	payload.magny = smoothedAverage(payload.magny, HMC5803L_Read(Y));
	payload.magnz = smoothedAverage(payload.magnz, HMC5803L_Read(Z));
#endif //_HMC5883L
#if _MEM
